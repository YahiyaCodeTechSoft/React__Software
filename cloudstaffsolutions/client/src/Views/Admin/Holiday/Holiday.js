        ...
        <Navbar expand="lg" className="navbar navv">
            <Container fluid className="mx-3">
                ...
                >
                    ...
                    <Nav.Link href="/holidayTable" className='py-1 px-3'><i class="fa-solid fa-floppy-disk"></i> Save</Nav.Link>
                    <Nav.Link href="/holidayTable" className='py-1 px-3'><i class="fa-solid fa-xmark"></i> cancel</Nav.Link>
                </Nav>
